...
CAPACITY = 1                    # The capacity of our resource
TIME_IN_BANK = 12.0             # The max time an operation can take
...
CREATE_GRAPHS = False           # Flag to create the graphs of the information
